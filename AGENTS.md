...
- Verifier reviews that mark work client-ready while leaving unresolved evidence, schema, consistency, or client-readiness blockers.
...
Use this taxonomy for verifier decisions, package gating, and handoffs:
...
Verifier reviews must always report all four readiness fields: `demo_readiness`, `internal_draft_readiness`, `client_readiness`, and `final_decision`.
